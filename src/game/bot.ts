...
export function botDecide(
  ...
  // parella (el company ja ha jugat) i el bot decideix tirar un 3.
  // Si el company ha senyalitzat que té carta bona (partnerAdvice
  // === "strong" / "Algo tinc"), cantar TRUC abans de jugar el 3.
  // Si advice és "weak" / "neutral" no es truca.
  ...
  if (r.tricks.length === 1 && trick.cards.length === 2) {
    ...
    if (partnerCard2P) {
      ...
      if (!partnerPlayedThreeOrTop) {
        ...
        // Tops meus que guanyen la millor de la mesa: tira la més baixa.
        ...
        // Si no tinc top guanyador, però tinc un 3 que guanye, tira'l.
