...
export function shouldConsultPartner(
  ...
  if (trickIdx === 1) {
    ...
    if (wonFirstTrick) {
      ...
      // parella en tirar (el company ja ha jugat) i tinc un 3. En un
      // 50% dels casos, pregunte "Què tens?" abans de tirar el 3:
      //   - si el company té carta bona ("Algo tinc") → el bot
      //     trucarà abans de jugar el 3.
      //   - si el company "No té res" → el bot tira el 3 sense trucar.
      if (currentTrick) {
